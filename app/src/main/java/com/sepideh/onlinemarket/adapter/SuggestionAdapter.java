...
public class SuggestionAdapter extends RecyclerView.Adapter<SuggestionAdapter.MyViewHolder> {
    ...
    public SuggestionAdapter(Context mContext, List<ProductInfo> suggestedProductList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.suggestion_row, viewGroup, false);
...
//                transaction.commit();
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView proImage;
        TextView proName, proBrand, proPrice, proDiscount;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            proPrice = itemView.findViewById(R.id.txv_price);
